...
public class ServicelevelObjectiveXMLProcessor extends XMLProcessor {
	...
	protected Map<String, Resource.Factory> getRegistrations() {
		if (registrations == null) {
			...
			registrations.put(XML_EXTENSION, new ServicelevelObjectiveResourceFactoryImpl());
			registrations.put(STAR_EXTENSION, new ServicelevelObjectiveResourceFactoryImpl());
		}
