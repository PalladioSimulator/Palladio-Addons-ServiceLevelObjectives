...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.servicelevelobjective.Threshold} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThresholdItemProvider extends IdentifierItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addThresholdLimitPropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addThresholdLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Threshold_thresholdLimit_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Threshold_thresholdLimit_feature",
								"_UI_Threshold_type"),
						ServicelevelObjectivePackage.Literals.THRESHOLD__THRESHOLD_LIMIT, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Threshold) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_Threshold_type")
