 ...
 * @generated
 */
public class ServicelevelObjectiveActionBarContributor extends EditingDomainActionBarContributor implements
ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
            ServicelevelobjectiveEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                ServicelevelObjectiveActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
            ServicelevelobjectiveEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return ServicelevelObjectiveActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (ServicelevelObjectiveActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ServicelevelObjectiveActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public ServicelevelObjectiveActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("servicelevelobjective-settings"));
        toolBarManager.add(new Separator("servicelevelobjective-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ServicelevelobjectiveEditorPlugin.INSTANCE.getString("_UI_ServicelevelObjectiveEditor_menu"),
                "org.palladiosimulator.servicelevelobjectiveMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                ServicelevelobjectiveEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                ServicelevelobjectiveEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
